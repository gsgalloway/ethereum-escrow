  ...
  describe('#buyerConfirmsAgreement', function () {
    describe('when called by the buyer with the right value', function () {
      ...
      it('should succeed', function () {
        let agreementId = 0;
        return instance.buyerConfirmsAgreement(agreementId, {
          from: buyer,
          value: buyersCost
        });
      });
    ...
    describe('when called by the buyer with the wrong value', function () {
      ...
      it('should fail', function () {
        ...
        return instance.buyerConfirmsAgreement(agreementId, {
          ...
          .then(() => {
            // If we get here, it means the above transaction worked. We're expecting it to
            // have failed, so this test has failed.
